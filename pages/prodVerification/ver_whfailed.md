...
keywords: Account Verification Failed Webhook
summary: "Account Verification Failed Webhook event"
sidebar: ver_sidebar
permalink: ver_whfailed.html
folder: prodVerification
toc: false
---

{% include webhook.html content="An account verification check has moved to status FAILED." %}

{% include wh-compatibility.html %}

## Webhook Message Details

This Webhook has just one event type: <b>VerificationFailed</b>
...
<code class="json">{
  ...
  "resourceReference": "n7rklmvdmq",
  "resourceReferenceType": "verificationId",
  "resourceUri": "/verifications/n7rklmvdmq",
  "resourceId": "n7rklmvdmq",
