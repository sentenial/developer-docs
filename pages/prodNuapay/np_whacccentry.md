---
title: Account Entry Event
keywords: Account Entry Event Webhook
summary: "Account Entry Webhook event: this message is triggered when there are any movements (credit or debit) on a Nuapay account."
sidebar: acc_sidebar
permalink: np_whacccentry.html
folder: prodNuapay
toc: false
---

{% include webhook.html content="A transaction is processed on the Nuapay account." %}

{% include wh-compatibility.html %}

## Webhook Message Details

This Webhook has just one event type: <b>AccountEntry</b>
...
<table cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td>string</td>
			<td>Mandatory</td>
			<td> This is the URI of the transaction. Use the URI to retrieve details of the transaction via the <a href="np_viewtransaction.html">Retrieve Transaction</a> service.</td>
		</tr>
		<tr>
			<td>root</td>
			<td>resourceId</td>
		...
		<tr>
			...
			<td>string</td>
			<td>Mandatory</td>
			<td>This is the type of the resource to which the URI is related. In this case it is an transaction resource.</td>
		</tr>
		<tr>
			<td>root</td>
			<td>reasonCode</td>
