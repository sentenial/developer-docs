...
{% include tip.html content="For [Developer Dashboard](wh_config_ui.html#setting-up-a-webhook) users: select the **PaymentReceived** event." %}
...
<code class="json">{
    ...
    "resourceReference": "31r8c5e2326f8b4d12345",
